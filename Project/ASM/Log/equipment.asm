...
.Name
  DB "HYPERCHARGE",$00
.Text
  DB !cO,"CHARGED SHOTS",!cW," ARE MORE ",!cR,"POWERFUL",!cW,". THEY NOW FIRE A ",!cB,"HYPER BEAM",!cW,".",$00
.Sprite
  %gfx2_entry(12)
  %pal_entry(40)
  DW $0001   ; oam
...
.Name
  DB "HYPER BEAM",$00
.Text
  DB "WHILE IN A ",!cG,"VERDITE LASER",!cW," BEAM WITH THE ",!cP,"METROID SUIT",!cW," EQUIPPED, SAMUS CAN CHANNEL THE ENERGY INTO HER ARMCANNON AND ",!cO,"FIRE",!cW," THE ",!cB,"HYPER BEAM",!cW,".",$00
.Sprite
  %gfx2_entry(15)
  %pal_entry(41)
  DW $0009   ; oam
