...
.Name
  DB "PIRATE LAB 1",$00
.Text
  DB "THIS SPACE PIRATE HIGH ENERGY ",!cG,"LABORATORY",!cW," IS EXPERIMENTING WITH A LOCAL MINERAL CALLED ",!cG,"VERDITE",!cW,". IT SEEMS THAT A POWERFUL BEAM THAT IS PRODUCED BY THE RESONANCE OF THE MINERAL WHEN REFINED. THERE MUST BE A NEARBY ",!cO,"POWER PLANT",!cW," TO SUSTAIN THIS LAB.",$00
.Sprite
  %gfx1_entry(11)
  %pal_entry(15)
  DW $000C   ; oam
