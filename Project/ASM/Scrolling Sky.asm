...
ScrollingSkySectionTable_List:
  ...
  DW ScrollingSkySectionTable_010, ScrollingSkySectionTable_012
...
ScrollingSkySectionTable_002: ;west ocean
  DW $0000 : DD $00008000 : DW $9F80
  DW $0088 : DD $0000C000 : DW $9F84
  DW $00e8 : DD $00014000 : DW $9F88
  DW $0118 : DD !repeated : DW $9F84
  DW $0150 : DD !repeated : DW $9F80
  DW $0190 : DD !repeated : DW $9F88
  DW $01B0 : DD !repeated : DW $9F80
  DW $01D0 : DD !repeated : DW $9F84
  DW $0200 : DD !repeated : DW $9F80
  DW $0228 : DD !repeated : DW $9F84
  DW $0278 : DD !repeated : DW $9F80
  DW $02F0 : DD $00007000 : DW $9F8C
  DW $0310 : DD !repeated : DW $9F84
  DW $0330 : DD !repeated : DW $9F80
  DW $0340 : DD $00000000 : DW $9F90
  DW $03B0 : DD $00000000 : DW $0000

ScrollingSkySectionTable_004: ;summit landing
  DW $0000 : DD $0000C000 : DW $9F84
  DW $0030 : DD $00008000 : DW $9F80
  DW $0070 : DD $00014000 : DW $9F88
  DW $0090 : DD !repeated : DW $9F80
  DW $00B0 : DD !repeated : DW $9F84
  DW $00E0 : DD !repeated : DW $9F80
  DW $0108 : DD !repeated : DW $9F84
  DW $0158 : DD !repeated : DW $9F80
  DW $01D0 : DD $00007000 : DW $9F8C
  DW $01F0 : DD $00000000 : DW $0000

ScrollingSkySectionTable_006: ;Ridley's room
  DW $0000 : DD $00008000 : DW $9F80
  DW $0020 : DD $0000C000 : DW $9F84
  DW $00A0 : DD !repeated : DW $9F80
  DW $00D8 : DD !repeated : DW $9F84
  DW $0138 : DD $00014000 : DW $9F88
  DW $0168 : DD !repeated : DW $9F84
  DW $01A0 : DD !repeated : DW $9F80
  DW $01D0 : DD !repeated : DW $9F88
  DW $01F0 : DD $00000000 : DW $0000

org $88F8A0
ScrollingSkySectionTable_008: ;Mass driver
  DW $0000 : DD $00000000 : DW $9F8C
  DW $0500 : DD $00028000 : DW $9F88
  DW $06C0 : DD $00018000 : DW $9F84
  DW $06D8 : DD $00010000 : DW $9F80
  DW $0710 : DD !repeated : DW $9F84
  DW $0738 : DD !repeated : DW $9F80
  DW $07D0 : DD !repeated : DW $9F84
  DW $07E0 : DD !repeated : DW $9F80
  DW $0820 : DD !repeated : DW $9F84
  DW $08A0 : DD !repeated : DW $9F80
  DW $08D8 : DD !repeated : DW $9F84
  DW $0938 : DD !repeated : DW $9F88
  DW $0968 : DD !repeated : DW $9F84
  DW $09A0 : DD !repeated : DW $9F80
  DW $09E0 : DD !repeated : DW $9F88
  DW $0A00 : DD !repeated : DW $9F80
  DW $0A20 : DD !repeated : DW $9F84
  DW $0A50 : DD !repeated : DW $9F80
  DW $0A78 : DD !repeated : DW $9F84
  DW $0AC8 : DD !repeated : DW $9F80
  DW $0B00 : DD $00000000 : DW $0000

ScrollingSkySectionTable_00A: ;Atrium
  DW $0000 : DD $00000000 : DW $9F80
  DW $0400 : DD $FFFFC000 : DW $9F84
  DW $0A00 : DD $00000000 : DW $0000

ScrollingSkySectionTable_00C: ;Reef floor crevice
  DW $0000 : DD $00000000 : DW $9F80
  DW $0080 : DD $FFFFC000 : DW $9F84
  DW $0600 : DD $00000000 : DW $0000

ScrollingSkySectionTable_00E: ; parlor
  DW $0000 : DD $00008000 : DW $9F80
  DW $0018 : DD $0000C000 : DW $9F84
  DW $0068 : DD !repeated : DW $9F80
  DW $00E0 : DD $00007000 : DW $9F8C
  DW $0100 : DD !repeated : DW $9F84
  DW $0120 : DD !repeated : DW $9F80
  DW $0130 : DD $00000000 : DW $9F90
  DW $01B0 : DD $00000000 : DW $0000

ScrollingSkySectionTable_010: ;thunder temple
  DW $0000 : DD $00000000 : DW $9F90
  DW $0060 : DD $00008000 : DW $9F80
  DW $0080 : DD $0000C000 : DW $9F84
  DW $00A0 : DD $00007000 : DW $9F8C
  DW $00C0 : DD !repeated : DW $9F80
  DW $00D0 : DD !repeated : DW $9F84
  DW $00E0 : DD !repeated : DW $9F80

  DW $00F8 : DD $00000000 : DW $9F90
  DW $0140 : DD !repeated : DW $9F80

  DW $0150 : DD $00014000 : DW $9F88
  DW $0160 : DD !repeated : DW $9F8C
  DW $0170 : DD !repeated : DW $9F84
  DW $0190 : DD !repeated : DW $9F80

  DW $01C0 : DD $00000000 : DW $9F90
  DW $0230 : DD !repeated : DW $9F84

  DW $0240 : DD !repeated : DW $9F80
  DW $0270 : DD !repeated : DW $9F84

  DW $0288 : DD $00000000 : DW $9F90
  DW $02C0 : DD !repeated : DW $9F84
  DW $02D0 : DD $00000000 : DW $9F90

  DW $02F0 : DD !repeated : DW $9F88
  DW $0318 : DD !repeated : DW $9F84

  DW $0340 : DD $00000000 : DW $9F90
  DW $0360 : DD !repeated : DW $9F80
  
  DW $0370 : DD !repeated : DW $9F88
  DW $0380 : DD $00000000 : DW $9F90

  DW $03A0 : DD !repeated : DW $9F80
  DW $03C0 : DD !repeated : DW $9F84
  DW $03F0 : DD !repeated : DW $9F80
  DW $0418 : DD !repeated : DW $9F84

  DW $0430 : DD $00000000 : DW $9F90
  DW $0468 : DD !repeated : DW $9F80

  DW $0490 : DD $00000000 : DW $9F90
  DW $04D8 : DD !repeated : DW $9F80

  DW $04E0 : DD !repeated : DW $9F8C
  DW $0500 : DD !repeated : DW $9F84
  DW $0520 : DD !repeated : DW $9F80
  DW $0530 : DD $00000000 : DW $9F90
  DW $0600 : DD $00000000 : DW $0000

ScrollingSkySectionTable_012: ;Reef
  DW $0000 : DD $00008000 : DW $9F80
  DW $0050 : DD $00007000 : DW $9F8C
  DW $0070 : DD $0000C000 : DW $9F84
  DW $0090 : DD $00014000 : DW $9F88
  DW $00C0 : DD !repeated : DW $9F80
  DW $00E0 : DD !repeated : DW $9F80
  DW $0100 : DD !repeated : DW $9F84
  DW $0120 : DD !repeated : DW $9F8C
  DW $0130 : DD !repeated : DW $9F80
  DW $0160 : DD $00000000 : DW $9F90
  DW $01A0 : DD $00000000 : DW $0000
warnpc $88FFFF
